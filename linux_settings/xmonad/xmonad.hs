...
startupWorkspace = "1:Brow"  -- which workspace do you want to be on after launch?
...
main = do
  ...
  , startupHook = do
      ...
      spawnToWorkspace "terminator" "2:Main" 
      spawnToWorkspace "google-chrome" "1:Brow" 
